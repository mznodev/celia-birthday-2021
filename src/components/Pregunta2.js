...
import pañuelos from "./images/pañuelos.png";
import ropaInterior from "./images/ropaInterior.png";
...
function Pregunta2() {
  ...
  return (
    <div className="App">
      ...
      <Pregunta>
        <H2>
          Pregunta 2: Es algo a lo que le podras dar uso pronto... ¿que será?
        </H2>
      </Pregunta>
      <Respuesta1 onClick={handleOpenWrong}>
        <H2>
          Un paquete de kleenex <ImagenRespuesta src={pañuelos} />
        </H2>
      </Respuesta1>
      <Respuesta2 onClick={handleOpenWrong}>
        <H2>
          Un conjunto de ropa interior <ImagenRespuesta src={ropaInterior} />
        </H2>
      </Respuesta2>
      <Respuesta3 onClick={handleOpenCorrect}>
        <H2>
          Unos palos de esos pa andar <ImagenRespuesta src={senderismo} />
        </H2>
      </Respuesta3>
      ...
      >
        <Fade in={openCorrect}>
          <div className={classes.paper}>
            ...
            <Button onClick={() => history.push("/pregunta3")}>
              Siguiente
            </Button>
          </div>
        </Fade>
