...
import cena from "./images/cenaRomantica.png";
import cena2 from "./images/cenaRomantica.png";
import masaje from "./images/masaje.png";
import wink from "./images/guiño.png";
...
function Pregunta4() {
  ...
  `;
  const Respuesta4 = styled.div`
    padding: 1em;
    margin-top: 1em;
    font-size: 0.8em;
    color: black;
    line-height: 1.8;
    background-color: rgba(76, 79, 79, 0.7);
    width: 40%;
    margin-left: 30.25%;
    &:hover {
      background-color: rgba(76, 79, 79, 1);
      //color: white;
    }
  `;
  ...
  return (
    <div className="App">
      ...
      <Pregunta>
        <H2>Pregunta 4: Una experiencia inolvidable es...</H2>
      </Pregunta>
      <Respuesta1 onClick={handleOpenWrong}>
        <H2>
          Una cena donde quieras <ImagenRespuesta src={cena} />
        </H2>
      </Respuesta1>
      <Respuesta2 onClick={handleOpenWrong}>
        <H2>
          Un masaje <ImagenRespuesta src={masaje} />
        </H2>
      </Respuesta2>
      <Respuesta3 onClick={handleOpenWrong}>
        <H2>
          Un vale por una noche fogosa <ImagenRespuesta src={wink} />
        </H2>
      </Respuesta3>
      <Respuesta4 onClick={handleOpenCorrect}>
        <H2>
          Todas son Correctas <ImagenRespuesta src={cena} />
          <ImagenRespuesta src={masaje} />
          <ImagenRespuesta src={wink} />
        </H2>
      </Respuesta4>
      ...
      >
        <Fade in={openCorrect}>
          <div className={classes.paper}>
            ...
            <ModalDescription id="transition-modal-description">
              Con este obsequio podrás recorrer todos los parajes naturales cual
            ...
            <Button onClick={() => history.push("/fin")}>Siguiente</Button>
          </div>
        </Fade>
      </Modal>
      <Modal
